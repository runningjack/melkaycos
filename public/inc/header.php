...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
	...
	<head>
		...
		<title> <?php echo $page_title != "" ? $page_title." - " : ""; ?>ADMIN MELKAY COSMETICS</title>
		...
		?>
				...
				<header id="header">
					<div id="logo-group">
						...
						<span id="logo"> <img src="<?php echo ASSETS_URL; ?>/img/logo_hr.png" alt="melkay cosmetics"> </span>
					...
					<div class="project-context hidden-xs">
						...
						<ul class="dropdown-menu">
							...
							<li>
								<a href="javascript:void(0);">Notes on pipeline upgrade</a>
							</li>
							<li>
								<a href="javascript:void(0);">Assessment Report for merchant account</a>
							</li>
							<li class="divider"></li>
							<li>
