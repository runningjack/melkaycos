                        ...
                        <div class="widget-body">
                            ...
                            <div id="myTabContent1" class="tab-content padding-10">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <fieldset>
                                                ...
                                                <div class="">
                                                    ...
                                                    <input type="hidden" id="audio" name="audio" value="{{$mypage[0]->audio}}" >
                                ...
                                <div class="tab-pane fade" id="s2">
                                    ...
                                    <!--Section to Add audio and Youtube video -->
                                    <p>
                                ...
                                <span class="button">
                                    ...
                                    <div class="row smart-form">
                                        <fieldset><legend>Video</legend>
                                            ...
                                            <label class="input input-file">
                                                <input class=""  type="text" placeholder="http://www.youtube.com/watch?v=UCOC1YwNwZw" name="video" id="video" value="{{$mypage[0]->video}}" >
                                            </label>
                                        </fieldset>
                                    ...
                                    <!--End of section for audio and youtube -->
